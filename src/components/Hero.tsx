...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      {/* Enhanced warm, organic background with animated gradients */}
      ...
      {/* Enhanced floating organic shapes with better animations */}
      <div className="container relative mx-auto px-6 py-20 md:py-28 lg:py-36 flex flex-col items-center">
        ...
        {/* Stats indicators with enhanced hover effects */}
